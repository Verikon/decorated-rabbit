  ...
  */
	async connect(props = {}) {
		...
		try {
			...
			if (this.provisions && this.provisions.length && props.noProvision !== true) await this.provision();
  ...
  */
	...
	awaitService(endpoint, props = {}) {
		...
		return new Promise(async (resolve, reject) => {
			...
			if (!hostname || !port) throw new error('Could not resovlve hostname and port from `' + endpoint + '`');
